...
static const char *cmuscmd[] = { "urxvt", "-e", "sh", "-c", "cmus", "&", "urxvt", "-e", "sh", "-c", "cava", NULL };
...
static Key keys[] = {
	...
	{ MODKEY|ShiftMask,		XK_t,	   spawn,	   {.v = telegrm } },
	{ MODKEY,			XK_Print,  spawn,	   {.v = screens } },
	TAGKEYS(                        XK_1,                      0)
	TAGKEYS(                        XK_2,                      1)
	TAGKEYS(                        XK_3,                      2)
	TAGKEYS(                        XK_4,                      3)
